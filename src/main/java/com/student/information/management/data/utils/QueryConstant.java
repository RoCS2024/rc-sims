...
public class QueryConstant {
     ...
     */
    public static String GET_ALL_STUDENTS_STATEMENT = "SELECT * FROM STUDENT";

    /**
     * SQL query to retrieves an student by their Student Number from the database.
     */
    public static String GET_STUDENT_BY_STUDENT_ID_STATEMENT = "SELECT * FROM STUDENT WHERE STUDENT_ID = ?";

    /**
     * SQL query that adds a new student to the database.
     */
    public static String ADD_STUDENT_STATEMENT = "INSERT INTO STUDENT VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    /**
     * SQL query to updates an existing student in the database.
     */
    public static String UPDATE_STATEMENT = "UPDATE student" +
     ...
     */
    public static String FIND_STUDENT_BY_EMAIL_STATEMENT = "SELECT * FROM STUDENT WHERE email = ?";
}
